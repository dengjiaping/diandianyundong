...
import com.fox.exercise.common.CommonUtil;
import com.fox.exercise.common.GetInfoFromFile;
import com.fox.exercise.common.MyMessage;
import com.fox.exercise.common.SCell;
import com.fox.exercise.common.SaveInfo;
import com.fox.exercise.common.UmsConstants;
...
//		deviceID = CommonUtil.getDeviceID(context);
        ...
        try {
            ...
            errorInfo.put("appkey", appkey);
            errorInfo.put("os_version", os_version);
            errorInfo.put("deviceid", uuidTemp);
        } catch (JSONException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
...
//			 BluetoothAdapter adapter = BluetoothAdapter.getDefaultAdapter();
            ...
            try {
                ...
                clientData.put("latitude", "0");
                clientData.put("longitude", "0");
