 ...
 */
public class BluetoothServiceNew {
    // Debugging
     ...
     */
    public BluetoothServiceNew(Handler handler) {
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        bundle.putString(BluetoothUtilNew.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothUtilNew.TOAST, "Unable to connect device");
        msg.setData(bundle);
        mHandler.sendMessage(msg);

        // Start the service over to restart listening mode
        BluetoothServiceNew.this.start();
    }
    ...
    private void connectionLost() {
        ...
        Message msg = mHandler.obtainMessage(5);
        Bundle bundle = new Bundle();
        bundle.putString(BluetoothUtilNew.TOAST, "Device connection was lost");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (BluetoothServiceNew.this) {
                        switch (mState) {
                            case STATE_LISTEN:
