...
//    }
    ...
    private class WeiboWebViewClient extends WebViewClient {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            ...
            Log.d(TAG, "mWeibo:" + mWeibo + "aa");
            Log.d(TAG, "mWeibo.getRedirectUrl():" + mWeibo.getRedirectUrl());
            if (url.startsWith(mWeibo.getRedirectUrl())) {
                Log.d(TAG, "mWeibo:" + mWeibo + "aa");
                handleRedirectUrl(view, url);
                view.stopLoading();
...
//            }
            if (!mSpinner.isShowing()) {
                Log.d(TAG, "mSpinner is showing:" + mSpinner.isShowing());
                mSpinner.show();
            }
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            Log.d(TAG, "mSpinner : " + mSpinner.toString());
            if (mSpinner.isShowing()) {
                Log.d(TAG, "mSpinner dismiss invoked: " + mSpinner.toString());
                mSpinner.dismiss();
                Log.d(TAG, "mSpinner after dismiss:" + mSpinner);
//            mSpinner=null;
            }
