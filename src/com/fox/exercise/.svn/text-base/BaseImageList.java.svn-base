...
public abstract class BaseImageList implements IImageList {
    ...
    private boolean isChildImageUri(Uri uri) {
        ...
        Uri base = mBaseUri;
        return Utils.equals(base.getScheme(), uri.getScheme())
                && Utils.equals(base.getHost(), uri.getHost())
                && Utils.equals(base.getAuthority(), uri.getAuthority())
                && Utils.equals(base.getPath(), getPathWithoutId(uri));
    }
