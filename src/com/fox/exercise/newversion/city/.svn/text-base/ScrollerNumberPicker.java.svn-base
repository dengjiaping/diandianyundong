package com.fox.exercise.newversion.city;
...
public class ScrollerNumberPicker extends View {
     ...
     * 画线画笔
     */
    private Paint linePaint,linePaint1;
    /**
     * 线的默认颜色
     */
    ...
    private class ItemObject {
        ...
        public void drawSelf(Canvas canvas) {
            ...
            // 判断是否被选择
            if (isSelected()) {
                selectedColor=getResources().getColor(R.color.setting_font);
                ...
                normalColor=getResources().getColor(R.color.gray_litter);
