...
import cn.ingenic.indroidsync.updater.VersionListView.OnVersionCheckedListener;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MSG_GET_WATCH_INFO: // 6
                    ...
                    Toast.makeText(CheckUpdateActivity.this, R.string.get_watch_failed, Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
