...
public class ImageList extends BaseImageList implements IImageList {
    ...
    private static final String BUCKET_ID = Media.BUCKET_ID + " = ?";

    protected String whereClause() {
        return mBucketId == null ? WHERE_CLAUSE : BUCKET_ID;
    }
    ...
    protected String[] whereClauseArgs() {
        ...
        if (mBucketId != null) {
            ...
            result[0] = mBucketId;
            //Log.v("ImageList"," result[0]="+result[0]+" result[1]="+result[1]+
    ...
    protected Cursor createCursor() {
        ...
        Cursor c = mContentResolver.query(mBaseUri, IMAGE_PROJECTION, whereClause(), whereClauseArgs(), sortOrder());
        return c;
    }
