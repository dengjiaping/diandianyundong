...
import com.fox.exercise.http.HttpsUtil;
...
public class Weibo {
    ...
    public static String SERVER = "https://upload.api.weibo.com/2/";
    ...
    private void startDialogAuth(Activity activity, String[] permissions) {
        ...
        dialog(activity, params, new WeiboDialogListener() {
            ...
            public void onComplete(Bundle values) {
                ...
                Log.v(TAG, "values is " + values);
                if (null == mAccessToken) {
                    mAccessToken = new Token();
                }
                Log.v("Weibo-authorize", "Token is " + values);
                ...
                if (code != null) {
                    new Thread() {
                        ...
                        public void run() {
                            ...
                            result = HttpsUtil.HttpsPost(
                                    WeiboConstParam.SINA_ACCESS_TOKEN + code, "");
                            try {
                                JSONObject jsonObject = new JSONObject(result);
                                mAccessToken.setToken(jsonObject.getString("access_token"));
                                mAccessToken.setExpiresIn(jsonObject.getString("expires_in"));
                                ...
                                if (isSessionValid()) {
                                    ...
                                    mAuthDialogListener.onComplete(bundle);
                                } else {
                    ...
                    Log.e(TAG, WeiboConstParam.SINA_ACCESS_TOKEN + code);
                }
            }
