...
public class BiaoZhuScrollLayout extends ViewGroup {
    ...
    public BiaoZhuScrollLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BiaoZhuScrollLayout(Context context, AttributeSet attrs, int defStyle) {
