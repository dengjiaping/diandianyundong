 ...
 * succeeds or fails.
 * <p/>
 * 这个是作为客户端 你连接别人  自己手机作为客户端 其他设备作为服务器
 * <p/>
 ...
 *//*
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(PedometerActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
 ...
 * @param device  The BluetoothDevice that has been connected
 *//*
    //不管自己作为是服务器还是客户端 这个都是用来接收或者发送信息的
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice
        ...
        Message msg = mHandler.obtainMessage(PedometerActivity.MESSAGE_DEVICE_NAME);
 ...
 *//*
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(PedometerActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
 ...
 *//*
    private class ConnectThread extends Thread {
        ...
        public ConnectThread(BluetoothDevice device, boolean secure) {
            ...
            mSocketType = secure ? "Secure" : "Insecure";
            SharedPreferences sharedPreferences =mContext.getSharedPreferences("sports", 0);
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    mHandler.obtainMessage(PedometerActivity.MESSAGE_READ, bytes, -1, buffer)
                            .sendToTarget();
                } catch (IOException e) {
 ...
 *//*
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(PedometerActivity.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
