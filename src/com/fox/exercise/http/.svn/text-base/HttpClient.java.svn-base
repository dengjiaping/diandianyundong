...
/*    private HttpRequestInterceptor preemptiveAuth = new HttpRequestInterceptor() {
     ...
     * @param authenticated need or not
     * @param httpMethod    HttpPost.METHOD_NAME
     *                      HttpGet.METHOD_NAME
...
//            response = mClient.execute(method,localcontext);
     ...
     * @param url
     * @return request URI
     * @throws HttpException Cause by URISyntaxException
     */
...
//    }
     ...
     * @param uri
     * @param file
     * @param postParams * @return httpMethod Request implementations for the various HTTP methods
     *                   like GET and POST.
     * @throws HttpException createMultipartEntity
     */
