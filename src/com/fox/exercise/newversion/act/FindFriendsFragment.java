...
import com.fox.exercise.FindMeActivity;
...
import com.fox.exercise.ResideMenu;
...
/**
 * @author loujungang 运动圈关注界面
 */
public class FindFriendsFragment extends AbstractBaseFragment implements
    ...
    public void setViewStatus() {
        ...
        view = LayoutInflater.from(getActivity()).inflate(
                R.layout.sports_find_goodfriends_fragment, null);
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                if (findBool == false) {
                    ...
                    mSportsApp.setSport_below_main_guanzhu(0);
                    findBool = true;
                    if (findnumber == 1) {
        ...
        commentsNotify.setOnClickListener(FindFriendsFragment.this);
        ...
        mSportsApp.setGoodfriendsHandler(msportsFindMoreHandler);
...
//                            mLoadProgressDialog.dismiss();
    ...
    public void initView() {
        findLayout = (RelativeLayout) view.findViewById(R.id.find_bottom);
        findLayout.setVisibility(View.GONE);
        mSportsApp.setSport_below_main_guanzhu(0);
        layoutVoice = (LinearLayout) view.findViewById(R.id.layoutVoice);
        ...
        findTextBtn = (ImageButton) view.findViewById(R.id.find_text_btn);
        findTextBtn.setOnClickListener(new findClickListener());
        loading = (ProgressBar) view.findViewById(R.id.loading);
        loading.setVisibility(View.VISIBLE);
        loading2 = (TextView) view.findViewById(R.id.loading2);
        loading2.setVisibility(View.VISIBLE);
        findExpressBtn = (ImageView) view.findViewById(
                (R.id.find_expression_text_btn_sportshow));

        findExpressBtn.setOnClickListener(new findClickListener());

        rScrollLayout = (RelativeLayout) view.findViewById(R.id.rScrollLayout);
        scrollLayout = (ScrollLayout) view.findViewById(R.id.ScrollLayoutTest);
        ...
        findUpcommentText = (LinearLayout) view
                .findViewById(R.id.find_upcomment_text);
        findUpcommentSend = (Button) view
                .findViewById(R.id.find_upcomment_send);
        findUpcommentSend.setOnClickListener(new findClickListener());
        findUnavailable = (Button) view.findViewById(R.id.find_unavailable);
        findUpcommentEdittext = (EditText) view
...
//                                mLoadProgressDialog.dismiss();
    ...
    public void onPageResume() {
        ...
        MobclickAgent.onPageStart("FindFriendsFragment");
    }

    @Override
    public void onPagePause() {
        MobclickAgent.onPageEnd("FindFriendsFragment");
    }
    ...
    private void init() {
        ...
        mPullSearchListView = (PullToRefreshListView) view
                .findViewById(R.id.sports_find_goodfriends_refresh_list);
        pop_menu_background = (RelativeLayout) view
                .findViewById(R.id.send_menu_background);
    }
                    ...
                    if (times == 0) {
                        if (mList.size() != 0){
                            ...
                            sportsfindmoreAdapter = new FindOtherMoreAdapter(
                                    getActivity(), actionLists, mList, mSportsApp,
                                    imgItems,imgItems2, 1);
...
//									toNumber = number;
                                            ...
                                            if (findBool == true) {
                                                ...
                                                if (number == 1) {
                                                    ...
                                                    showUIedit();
                                                    findTextBtn.setBackgroundResource(R.drawable.sk2text);
                                                    mSportsApp.setSport_below_main_guanzhu(1);
                                                    if (findnumber == 0) {
                                                        resideMenu
                        ...
                        if (sportsfindmoreAdapter == null && mList.size() != 0) {
                            ...
                            sportsfindmoreAdapter
                                    .setOnCheckedChangeListener(new OnCheckedChangeCommentListener() {
                                        /**
                                         * (position,findIdString,2,commentID,
                                         * theFirstName) 第一个参数所属发现在list中位置
                                         * 第二个参数发现ID， 第三个参数用来判断评论还是回复1代表直接评论2代表回复
                ...
                case FRESH_LIST_TOP:
                    if (mList_top != null && mList_top.size() != 0) {
                        ...
                        for (int i = 0; i < mList_top.size(); i++) {
                            if (mList_top.get(i).getIsFriends() == 1) {
...
//                            mLoadProgressDialog.dismiss();
    ...
    public void shotSelectImages() {
        ...
        myWindow.setOnDismissListener(FindFriendsFragment.this);
    ...
    private static final int COMMENT_ACTIVITY_REQUEST_CODE = 3;
...
//                    mLoadProgressDialog.dismiss();
    ...
    public void loadDate() {
        ...
        if (getActivity() != null) {
            ...
            //获取缓存数据
            SharedPreferences preferences = SportsApp.getInstance().getSharedPreferences("FindGroupList", 0);
            String content = preferences.getString("FindGroupList_info", "");
    ...
    class SportsFindMoreThread_top extends Thread {
        ...
        public void run() {
            ...
            if (list != null) {
                if (list.size() == 0) {
                    msg = Message
                            .obtain(msportsFindMoreHandler, FRESH_NULL_TOP);
                    msg.sendToTarget();
                } else {
                    mList_top.clear();
                    for (FindGroup e : list) {
                    ...
                    msg = Message
                            .obtain(msportsFindMoreHandler, FRESH_LIST_TOP);
                    msg.sendToTarget();
                }
            } else {
                if (list == null) {
