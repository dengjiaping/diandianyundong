...
//	private static final int START_TASK = 0x0001;
    ...
    protected ImageWorker(Context context) {
        mContext = context;
        //mLoadingBitmap = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.sports_residemenu_man);
     ...
     * @param mHandler
     *            pass a handler to ensure the progressbar show correctly
     * @param filterUrl
     *            if the pic download from our app server, we need to normal
    ...
    public static boolean isImage(String type) {
        if (type != null && (type.equals("jpg") || type.equals("gif")
    ...
    private void setImageBitmap(ImageView imageView, Bitmap bitmap) {
        if (mFadeInBitmap) {
            ...
            /*if (type==0) {
				...
				imageView.setBackgroundColor(mContext.getResources().getColor(R.color.gray_litter));
			}*/
            imageView.setBackgroundDrawable(new BitmapDrawable(mContext.getResources(), mLoadingBitmap));
