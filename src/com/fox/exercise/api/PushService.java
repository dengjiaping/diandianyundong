...
//	private static final String		MQTT_HOST = "118.186.34.123";
...
//	private static short			MQTT_KEEP_ALIVE           = 60*2;
...
//	public static String			MQTT_CLIENT_ID = "zuimei";
//
...
//
//	// Notification title
//	public static String			NOTIF_TITLE = "17FOX"; 	
//	// Notification id
...
//			return false;
//		}
//		log(Boolean.toString(info.isConnected()));
...
////			Toast.makeText(PushService.this, s, Toast.LENGTH_SHORT).show();
//			showNotification(s);	
//			log("Got message: " + s);
//		}   
//		
