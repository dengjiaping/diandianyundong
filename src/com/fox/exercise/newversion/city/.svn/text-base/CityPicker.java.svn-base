...
import com.fox.exercise.newversion.city.ScrollerNumberPicker.OnSelectListener;
...
public class CityPicker extends LinearLayout {
    ...
    private String provinceString, cityString, conuyString;

    public String getProvince_string() {
        provinceString = provincePicker.getSelectedText();
        return provinceString;
    }

    public String getCity_string() {
        cityString = cityPicker.getSelectedText();
        return cityString;
    }

    public String getCouny_string() {
        conuyString = counyPicker.getSelectedText();
        return conuyString;
    }
