...
import com.fox.exercise.pedometer.CaloriesNotifier;
import com.fox.exercise.pedometer.DistanceNotifier;
import com.fox.exercise.pedometer.PaceNotifier;
import com.fox.exercise.pedometer.PedometerSettings;
import com.fox.exercise.pedometer.SpeakingTimer;
import com.fox.exercise.pedometer.SpeedNotifier;
import com.fox.exercise.pedometer.StepDetector;
import com.fox.exercise.pedometer.StepDisplayer;
...
public class FirstStepService extends Service {
    ...
    public class StepBinder extends Binder {
        public FirstStepService getService() {
            return FirstStepService.this;
        }
    }
    ...
    public void onCreate() {
        ...
        Log.e(TAG, "UID : " + mSportsApp.getSportUser().getUid());
        mState = getSharedPreferences("UID" + Integer.toString(mSportsApp.getSportUser().getUid()), 0);
...
//        mUtils.initTTS();
        ...
        mStepDisplayer.setSteps(mLastSteps = mState.getInt("steps", 0));
...
//        mSpeakingTimer.addListener(mCaloriesNotifier);
        ...
        mLastDate = mState.getLong("date", 0);
        Date saveDate = new Date(mLastDate);
        Date nowDate = new Date(System.currentTimeMillis());
        Log.e(TAG, "save day : " + saveDate.getYear() + ":" + saveDate.getMonth() + ":" + saveDate.getDate() +
                ", now day : " + nowDate.getYear() + ":" + nowDate.getMonth() + ":" + nowDate.getDate());
        if ((saveDate.getYear() < nowDate.getYear()) ||
                (saveDate.getMonth() < nowDate.getMonth()) ||
                (saveDate.getDate() < nowDate.getDate())) {
            mLastSteps = 0;

            mStateEditor = mState.edit();
            mStateEditor.putLong("date", System.currentTimeMillis());
            mStateEditor.putInt("steps", mLastSteps);
...
//        mUtils.shutdownTTS();
        ...
        mStateEditor = mState.edit();
        mStateEditor.putLong("date", System.currentTimeMillis());
        mStateEditor.putInt("steps", mLastSteps + mSteps);
//        mStateEditor.putInt("pace", mPace);
//        mStateEditor.putFloat("distance", mDistance);
//        mStateEditor.putFloat("speed", mSpeed);
//        mStateEditor.putFloat("calories", mCalories);
...
//        Toast.makeText(this, getText(R.string.stopped), Toast.LENGTH_SHORT).show();
    ...
    public void reloadSettings() {
        ...
        if (mStepDetector != null) {
            mStepDetector.setSensitivity(
                    Float.valueOf(mSettings.getString("sensitivity", "8.5"))
            );
        }
    ...
    private StepDisplayer.Listener mStepListener = new StepDisplayer.Listener() {
        public void stepsChanged(int value) {
            Log.e(TAG, "mLastSteps : " + mLastSteps + ", value : " + value);
            mSteps = value;
            passValue();
        }
        ...
        public void passValue() {
            if (mCallback != null) {
                mCallback.stepsChanged(mLastSteps + mSteps);
            }
        }
    };
    /**
...
//        pedometerIntent.setComponent(new ComponentName(this, MyFirstSportFragment.class));
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals(Intent.ACTION_SCREEN_OFF)) {
                ...
                FirstStepService.this.unregisterDetector();
                FirstStepService.this.registerDetector();
