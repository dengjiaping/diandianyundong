...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
    ...
    public static final int MODE_PROHIBIT = 0x4;
    ...
    public void prohibitMode() {
        this.currentMode = MODE_PROHIBIT;
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        String pullToLoadLabel = context.getString(R.string.pull_to_loadmore_pull_label);
        String loadingLabel = context.getString(R.string.pull_to_loadmore_loading_label);
        String releaseToLoadLabel = context.getString(R.string.pull_to_loadmore_release_label);

        // Add Loading Views
        if (mode == MODE_PULL_DOWN_TO_REFRESH || mode == MODE_BOTH) {
            headerLayout = new LoadingLayout(context, MODE_PULL_DOWN_TO_REFRESH, releaseToRefreshLabel, pullToRefreshLabel,
                    refreshingLabel);
        ...
        if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
            footerLayout = new LoadingLayout(context, MODE_PULL_UP_TO_REFRESH, releaseToLoadLabel, pullToLoadLabel, loadingLabel);
