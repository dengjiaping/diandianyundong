...
public class WheelView extends View {
     ...
     * Items text color
     */
    private static final int ITEMS_TEXT_COLOR = 0x1e000000;
     ...
     */
    private static final int ADDITIONAL_ITEM_HEIGHT = 85;

    /**
     * Text size
     */
    private static final int TEXT_SIZE = SportsApp.getInstance().dip2px(17);
    /**
    ...
    private void initResourcesIfNecessary() {
        ...
        if (linePaint==null){
            ...
            linePaint.setColor(getResources().getColor(R.color.setting_font2));
        ...
        if (linePaint1==null){
            ...
            linePaint1.setColor(getResources().getColor(R.color.setting_font1));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(50, offset+20, getWidth()-50, offset+20,
                        linePaint);

        canvas.drawLine(50, 3*offset+10, getWidth()-50, 3*offset+10,
                linePaint1);
