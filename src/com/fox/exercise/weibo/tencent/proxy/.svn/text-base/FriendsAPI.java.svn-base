...
import com.fox.exercise.weibo.tencent.OAuth;
import com.fox.exercise.weibo.tencent.QArrayList;
...
public class FriendsAPI extends BasicAPI {
    ...
    private String friendsMatchNickTipsUrl = apiBaseUrl + "/friends/match_nick_tips";
    ...
    public String matchNickTips(OAuth oAuth, String format, String match, String reqnum) throws Exception {
        QArrayList paramsList = new QArrayList();
        paramsList.add(new BasicNameValuePair("format", format));
        paramsList.add(new BasicNameValuePair("match", match));
        paramsList.add(new BasicNameValuePair("reqnum", reqnum));

        return requestAPI.getResource(friendsMatchNickTipsUrl, paramsList, oAuth);
    }
