...
public class PreviewFrameLayout extends ViewGroup {
    ...
    protected void onFinishInflate() {
        mFrame = (FrameLayout) findViewById(R.id.camera_frame);
        if (mFrame == null) {
    ...
    public void setMask(int hS, int vS) {
    	mHS = hS;
    	mVS=vS;
    	Log.d(TAG,"requestLayout invoked");
    	requestLayout();
    }
...
//        Log.v("layout","frameWidth="+frameWidth+" frameHeight="+frameHeight);
...
//        }
//
//        //frameHeight = b;//+ verticalPadding;
//        //frameWidth = frameHeight *previewWidth/previewHeight;// + horizontalPadding;
//        Log.v("layout","frameWidth="+frameWidth+" frameHeight="+frameHeight);
//
...
//        mFrame.layout(l, t, r - hSpace, b - vSpace);
